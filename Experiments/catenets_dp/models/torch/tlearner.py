...
from .base import DEVICE, BaseCATEEstimator, BasicNet
from .utils.model_utils import predict_wrapper, train_wrapper
...
class TLearner(BaseCATEEstimator):
    ...
    def fit(
        ...
        for widx, plugin in enumerate(self._plug_in):
            train_wrapper(plugin, X[w == widx], y[w == widx], epsilon, delta)
